...
(function(exported) {
	...
	Track.prototype.setBlend = Track.prototype.blend = function (channel, blend1, blend2) {
		this.events.push(new MidiEvent({
			type: MidiEvent.PITCH_BEND,
			channel: channel,
			param1: blend1,
			param2: blend2
		}));
	...
	Track.prototype.setPan = Track.prototype.pan = function (channel, pan) {
		this.events.push(new MidiEvent({
